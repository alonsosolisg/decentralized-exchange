...
describe("Exchange", () => {
    let exchange, deployer, feeAccount, accounts, token1, user1, token2, user2
    ...
    beforeEach( async () => {
        ...
        token1 = await Token.deploy("Elephant", "ELPH", "500000")
        token2 = await Token.deploy("Stable Savanna", "SAV", "1000000")
    ...
    describe("Depositing Tokens", () => {
        ...
        describe("Success", () => {
            ...
            it('emits Deposit event', async () => {
                const event = result.events[1] //2 events emitted
    ...
    describe("Checking Balances", () => {
        ...
        let amount = tokens(1)
            ...
            it("it returns user balance", async () => {
                expect(await exchange.balanceOf(token1.address, user1.address)).to.equal(amount);
            })
    })
    ...
    describe("Order Actions", async () => {
        ...
        describe("Cancelling Orders", async () => {
            ...
            describe("Failure", async () => {
                ...
                it("rejects invalid unauthorized cancellations", async () => {
